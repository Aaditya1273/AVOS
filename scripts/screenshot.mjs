...
// The default tab is Razorpay; the proof-card and replay captures are from the
// evaluation console, which is the second top-level tab.
await page.getByRole('tab', { name: 'AVOS Evaluation' }).click()
...
// 4. The landing page: the pitch, above the fold.
