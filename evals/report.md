...
Generated: 2026-09-05T11:58:19.646Z
...
| Throughput (verify only) | 5,238 records/sec |
...
| Throughput (verify only) | 5,364 records/sec |
...
- **Throughput** is deterministic verification only: 5,238 records/sec over 120 cases
  (23 ms). Agent proposal for all 150 cases took
  52 ms on the offline mock. The two are reported
