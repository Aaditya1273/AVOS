...
Generated: 2026-09-05T11:04:27.444Z
...
| Throughput (verify only) | 4,313 records/sec |
...
| Throughput (verify only) | 4,412 records/sec |
...
- **Throughput** is deterministic verification only: 4,313 records/sec over 120 cases
  (28 ms). Agent proposal for all 150 cases took
  60 ms on the offline mock. The two are reported
