...
Generated: 2026-09-04T11:20:24.902Z
...
| Throughput (verify only) | 4,682 records/sec |
...
- **Throughput** is deterministic verification only: 5,005 records/sec over 120 cases
  (24 ms). Agent proposal for all 150 cases took
  51 ms on the offline mock. The two are reported
